<p align="center">
  <img src="./assets/readme/hero.svg" width="100%"
       alt="AnyDoc MD Converter — Finder Quick Action, конвертирующее документы в Markdown локально, без OCR и без сети">
</p>

Правый клик по файлам или папкам в Finder → «Конвертировать в Markdown (без OCR)». Движок —
[Firecrawl AnyDoc](https://github.com/firecrawl/anydoc) (чистый Rust, Python-пакет `firecrawl-anydoc`):
всё считается локально, файлы никуда не отправляются.
...
<p align="center">
  <img src="./assets/readme/workflow.svg" width="100%"
       alt="Четыре шага: выделить файлы в Finder, вызвать Быстрое действие, локальная обработка без сети, результат и лог">
</p>
...
- Картинки внутри docx/pptx заменяются alt-текстом; сканы, вложенные в офисные документы, OCR пока
  не проходят (AnyDoc отдаёт их байты в `document.assets`, это следующий шаг).
